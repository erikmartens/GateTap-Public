...
## 1. Prehľad
GateTap (ďalej len „aplikácia“) poskytuje mobilné rozhranie na interakciu s lokálne hosťovanými systémami riadenia prístupu prostredníctvom vašej lokálnej siete.

## 2. Bez pridruženia
GateTap je nezávislá aplikácia a nie je prepojená so žiadnym výrobcom hardvéru ani poskytovateľom riadenia prístupu, nie je ním podporovaná ani k nemu nie je pripojená.
...
## 4. Bezpečnosť
GateTap ukladá poverenia lokálne vo vašom zariadení. Zodpovedáte za zabezpečenie svojho zariadenia (napr. prístupový kód, Face ID).

Aplikácia komunikuje priamo so zariadeniami vo vašej lokálnej sieti a neposkytuje žiadnu infraštruktúru vzdialeného prístupu.
...
- Používanie aplikácie v kritických prostrediach alebo prostrediach citlivých na bezpečnosť
