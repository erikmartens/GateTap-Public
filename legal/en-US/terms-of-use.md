...
## 1. Overview
GateTap ("the App") provides a mobile interface to interact with locally hosted access control systems via your local network.

## 2. No Affiliation
GateTap is an independent application and is not affiliated with, endorsed by, or connected to any hardware manufacturer or access control provider.
...
## 4. Security
GateTap stores credentials locally on your device. You are responsible for securing your device (e.g., passcode, Face ID).

The App communicates directly with devices on your local network and does not provide any remote access infrastructure.
...
- Use of the App in critical or security-sensitive environments
