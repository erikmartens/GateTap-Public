...
## 1. Genel Bakış
GateTap ("Uygulama"), yerel ağınız üzerinden yerel olarak barındırılan erişim kontrol sistemleriyle etkileşim kurmak için bir mobil arayüz sağlar.

## 2. Bağlantı Yok
GateTap bağımsız bir uygulamadır ve herhangi bir donanım üreticisine veya erişim kontrol sağlayıcısına bağlı değildir, bunlar tarafından desteklenmez veya bunlarla bağlantılı değildir.
...
## 4. Güvenlik
GateTap kimlik bilgilerini cihazınızda yerel olarak saklar. Cihazınızın (ör. şifre, Face ID) güvenliğini sağlamak sizin sorumluluğunuzdadır.

Uygulama, yerel ağınızdaki cihazlarla doğrudan iletişim kurar ve herhangi bir uzaktan erişim altyapısı sağlamaz.
...
- Uygulamanın kritik veya güvenliğe duyarlı ortamlarda kullanılması
